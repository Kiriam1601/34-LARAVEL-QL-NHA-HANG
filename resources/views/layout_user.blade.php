...
<head>
    <meta charset="utf-8">
    <title>Nhà hàng Thiên Lý Ơi</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta content="" name="keywords">
    <meta content="" name="description">

    <!-- Favicon -->
    <link href="{{ asset('/public/upload/logo/favicon-restautrant.png') }}" rel="icon">
            ...
            <div class="container py-5">
                <div class="row g-5">
                    <div class="col-lg-3 col-md-6">
                        ...
                        <a class="btn btn-link" href="{{ route('about-us') }}">Chúng tôi</a>
                        <a class="btn btn-link" href="{{ route('contact') }}">Liên hệ</a>
                        <a class="btn btn-link" href="{{ route('menu') }}">Menu bàn</a>
                        <a class="btn btn-link" href="{{ route('order-table') }}">Đặt bàn</a>
                        {{-- <a class="btn btn-link" href="">Terms & Condition</a> --}}
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <h4 class="section-title ff-secondary text-start text-primary fw-normal mb-4">Liện hệ</h4>
                        <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>Cái Răng, Cần Thơ</p>
                        <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>0123.456.789</p>
                        <p class="mb-2"><i class="fa fa-envelope me-3"></i>nhahang.contact@gmail.com</p>
                ...
                <div class="copyright">
                    <div class="row">
                        <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                            &copy; <a class="border-bottom" href="">Hi web </a>, All Right Reserved.

                            <!--/*** This template is free as long as you keep the footer author’s credit link/attribution link/backlink. If you'd like to use the template without the footer author’s credit link/attribution link/backlink, you can purchase the Credit Removal License from "https://htmlcodex.com/credit-removal". Thank you for your support. ***/-->
                            Designed By <a class="border-bottom" href="">Khoa Dev</a>
                        </div>
                        <div class="col-md-6 text-center text-md-end">
                            <div class="footer-menu">
                                <a href="{{ route('home') }}">Trang chủ</a>
                                <a  href="{{ route('about-us') }}">Chúng tôi</a>
                                <a href="{{ route('contact') }}">Liên hệ</a>
                                <a  href="{{ route('menu') }}">Menu bàn</a>
                                <a href="{{ route('order-table') }}">Đặt bàn</a>
                            </div>
                        </div>
                    </div>
                </div>
