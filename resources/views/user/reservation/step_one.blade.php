                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" id="name" placeholder="Nhập họ tên"
                                       value="{{ old('datban_ten', $reservation->datban_ten ?? '') }}" name="datban_ten">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="email" class="form-control" id="email" placeholder="Nhập Email"
                                        value="{{ old('datban_email', $reservation->datban_email ?? '') }}" name="datban_email">
                            ...
                            <div class="col-md-12">
                                <div class="form-floating">
                                    <input type="number" class="form-control" id="email"
                                        placeholder="Nhập số điện thoại" value="{{ old('datban_sdt', $reservation->datban_sdt ?? '') }}"
                                        name="datban_sdt">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating date" id="date3" data-target-input="nearest">
                                    {{-- <input type="datetime-local" class="form-control "
                                        ...
                                        min="{{ $min_date->format('Y-m-d\TH:i:s') }}"
                                        max="{{ $max_date->format('Y-m-d\TH:i:s') }}"
                                        value="{{ old('datban_thoigian', $reservation ? Carbon\Carbon::parse($reservation->datban_thoigian)->format('Y-m-d\TH:i:s') : '') }}"
                                        name="datban_thoigian" />
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" id="datban_slnguoi"
                                        value="{{ old('datban_slnguoi', $reservation->datban_slnguoi ?? '') }}" placeholder="Nhập số lượng người"
                                        name="datban_slnguoi">
