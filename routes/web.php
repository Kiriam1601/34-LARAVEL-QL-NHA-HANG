...
Route::get('/step-one', [App\Http\Controllers\UserController::class, 'step_one'])->name('order-table');
...
Route::get('/about-us', [App\Http\Controllers\UserController::class, 'about_us'])->name('about-us');
...
Route::get('/admin/login', [App\Http\Controllers\AuthController::class, 'login_auth'])->name('login.admin');
