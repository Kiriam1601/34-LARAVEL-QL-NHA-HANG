...
class AuthController extends Controller
{
    ...
    public function login(Request $request)
    {
        ...
        // // if(Auth::attempt(['nv_email' => $request->admin_email, 'nv_matkhau' => $request->admin_password, 'nv_tinhtrang' => 0]) ){
        ...
        // // elseif(Auth::attempt(['nv_email' => $request->admin_email, 'nv_matkhau' => $request->admin_password])){
