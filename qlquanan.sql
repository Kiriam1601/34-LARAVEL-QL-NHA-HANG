...
--
-- Host: localhost:3306
-- Generation Time: Mar 30, 2025 at 02:26 PM
...
CREATE TABLE `baiviet` (
  ...
  `baiviet_tinhtrang` int NOT NULL,
...
CREATE TABLE `ban` (
  ...
  `ban_ten` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `ban_tinhtrang` int NOT NULL,
  `ban_slnguoi` int NOT NULL,
  `ban_dat` int NOT NULL,
...
(19, 'Bàn 33', 1, 6, 0, NULL, '2023-09-21 08:30:04'),
...
(24, 'Bàn 88', 1, 2, 0, '2023-09-27 11:56:37', NULL),
...
CREATE TABLE `binhluan` (
  ...
  `khachhang_id` int UNSIGNED NOT NULL,
  `binhluan_noidung` varchar(255) NOT NULL,
  `binhluan_tinhtrang` int NOT NULL,
...
--
-- Table structure for table `ctdinhluong`
--

CREATE TABLE `ctdinhluong` (
  `ctdl_id` int NOT NULL,
  `dl_id` int UNSIGNED NOT NULL,
  `nl_id` int UNSIGNED NOT NULL,
  `ctdl_sl` float NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

--
-- Dumping data for table `ctdinhluong`
--
...
CREATE TABLE `cthoadon` (
  `cthoadon_id` int UNSIGNED NOT NULL,
  `hoadon_id` int UNSIGNED NOT NULL,
  `ma_id` int UNSIGNED NOT NULL,
  `cthoadon_slsp` int NOT NULL,
  `cthoadon_giasp` int NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(1447, 384, 16, 1, 25000, NULL, NULL),
(1448, 384, 18, 1, 35000, NULL, NULL),
(1449, 384, 28, 1, 35000, NULL, NULL),
(1450, 384, 36, 1, 15000, NULL, NULL),
(1451, 384, 38, 1, 15000, NULL, NULL),
(1452, 385, 29, 1, 35000, NULL, NULL),
(1453, 385, 16, 1, 25000, NULL, NULL),
(1454, 385, 38, 1, 15000, NULL, NULL),
(1455, 385, 28, 1, 35000, NULL, NULL),
(1456, 385, 20, 1, 25000, NULL, NULL),
(1457, 385, 19, 1, 35000, NULL, NULL),
(1458, 386, 19, 1, 35000, NULL, NULL),
(1459, 386, 18, 1, 35000, NULL, NULL),
(1460, 386, 20, 1, 25000, NULL, NULL),
(1461, 386, 35, 2, 15000, NULL, NULL),
(1462, 386, 37, 1, 15000, NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `ctphienlamviec`
--

CREATE TABLE `ctphienlamviec` (
  `ctphien_id` int UNSIGNED NOT NULL,
  `phienlamviec_id` int UNSIGNED NOT NULL,
  `ctphien_motachi` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `ctphien_sotienchi` int NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `ctphienlamviec`
--
...
--
-- Table structure for table `ctphieunhaphang`
--

CREATE TABLE `ctphieunhaphang` (
  `ctnh_id` int NOT NULL,
  `pnh_id` int UNSIGNED NOT NULL,
  `ncc_id` int UNSIGNED NOT NULL,
  `nl_id` int UNSIGNED NOT NULL,
  `ctnh_soluong` int NOT NULL,
  `ctnh_dongia` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

--
-- Dumping data for table `ctphieunhaphang`
--
...
CREATE TABLE `ctquyen` (
  `ctquyen_id` int NOT NULL,
  `quyen_id` int UNSIGNED NOT NULL,
  `nv_id` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `danhmuc` (
  ...
  `danhmuc_ten` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `danhmuc_mota` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `danhmuc_tinhtrang` int NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `datban` (
  ...
  `datban_tinhtrang` int NOT NULL,
  `datban_slnguoi` int NOT NULL,
  `datban_kt` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
(120, 16, 37, 'Trần Thị B', 'khoacntt2003@gmail.com', '0123456789', '2025-03-31 13:21:00', 0, 4, 0);
...
CREATE TABLE `giamgia` (
  `gg_id` int UNSIGNED NOT NULL,
  `gg_ten` varchar(150) NOT NULL,
  `gg_stg` int NOT NULL,
  `gg_tinhnang` int NOT NULL,
  `gg_soluong` int NOT NULL,
...
(5, 'Giảm giá khung giờ vàng', 10, 2, 8, 'SALE2025', '2025-03-30', '2026-12-01'),
...
CREATE TABLE `hoadon` (
  ...
  `ban_id` int UNSIGNED NOT NULL,
  `khachhang_id` int UNSIGNED NOT NULL,
  `gg_id` int UNSIGNED DEFAULT NULL,
  `hoadon_tinhtrang` int NOT NULL,
  `hoadon_tongtien` int NOT NULL,
  `hoadon_ghichu` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `hoadon_httt` int NOT NULL,
...
(384, 1, 107, 16, 39, 5, 3, 112500, 'Khách VIP', 1, '2025-03-30 13:28:18', NULL, NULL),
(385, 1, 107, 19, 41, NULL, 0, 170000, 'Khách VIP', 0, '2025-03-30 13:18:05', NULL, NULL),
(386, 1, 107, 24, 43, NULL, 0, 140000, 'Khách quen', 0, '2025-03-30 13:29:30', NULL, NULL);
...
CREATE TABLE `khachhang` (
  `khachhang_id` int UNSIGNED NOT NULL,
  `khachhang_ten` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `khachhang_sdt` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `khachhang_hinhanh` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `khachhang_diachi` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `khachhang_email` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `khachhang_matkhau` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `khachhang_trangthai` int NOT NULL,
  `khachhang_token` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(37, 'Nguyễn Văn A', '0123456789', 'avatar_it.png', 'Tỉnh Vĩnh Long , Huyện Vũng Liêm , Xã Trung Thành Đông Hẻm 30', 'khachhang@gmail.com', 'a66abb5684c45962d887564f08346e8d', 1, NULL, NULL, NULL),
...
(2, 'smtp', 'smtp.googlemail.com', '465', 'chamsockhachhang.contact@gmail.com', 'htjxzbpjoigzycxp', 'ssl', 'chamsockhachhang.contact@gmail.com');
...
CREATE TABLE `monan` (
  `ma_id` int UNSIGNED NOT NULL,
  `danhmuc_id` int UNSIGNED NOT NULL,
  `ma_ten` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `ma_mota` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `ma_noidung` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `ma_gia` int NOT NULL,
  `ma_hinhanh` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
(7, 'Gạo', 'kilogam', 1, 17, 11.5),
(8, 'Thịt heo', 'kilogam', 1, 8.25, 1.75),
(9, 'Cà chua', 'kilogam', 1, 3.3, 5.9),
(10, 'Dưa leo', 'Kilogam', 1, 3.3, 5.9),
(11, 'Thịt gà', 'kilogam', 1, 5.5, 13.3),
(12, 'Bún gạo', 'kilogam', 1, 19.1, 0.9),
(13, 'Thịt bò', 'kilogam', 1, 10.3, 0.2),
(14, 'Giá đỗ', 'kilogam', 1, 8.4, 1.4),
(15, 'Bánh phở', 'kilogam', 1, 9.4, 0.9),
(16, 'Xà lách', 'kilogam', 1, 10, 0),
(17, 'Sting', 'lon', 1, 18, 3),
(18, 'Pepsi', 'lon', 1, 22, 3),
(20, 'Cua đồng', 'kilogam', 1, 2.2, 1.75),
(21, 'Cá lóc', 'kilogam', 1, 4.9, 0.4),
(22, 'Tép', 'kilogam', 1, 4.9, 0.4),
(23, 'Coca', 'lon', 1, 16, 4),
(24, '7up', 'lon', 1, 14, 4);
...
CREATE TABLE `nhanvien` (
  `nv_id` int UNSIGNED NOT NULL,
  `nv_email` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `nv_matkhau` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `nv_ten` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `nv_sdt` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `nv_hinhanh` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `nv_diachi` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `nv_tinhtrang` int NOT NULL,
  `nv_token` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(1, 'admin@gmail.com', '$2y$10$i8cl3IscBQewJ1euycbMVeLSglwQ11kDIgr46JiN1Oyy5vrXYRGsq', 'Quản trị viện', '1234567890', 'avatar.png', 'Thành phố Cần Thơ , Quận Ninh Kiều , Phường Xuân Khánh, Đường 30/4', 1, NULL, NULL, NULL),
(2, 'nvphucvu@gmail.com', '$2y$10$i8cl3IscBQewJ1euycbMVeLSglwQ11kDIgr46JiN1Oyy5vrXYRGsq', 'Nhân viên phục vụ', '1234567890', 'avatar_user1.png', 'Thành phố Cần Thơ , Quận Ninh Kiều , Phường Xuân Khánh, Đường 3/2', 1, '', NULL, NULL),
(3, 'nvbep@gmail.com', '$2y$10$i8cl3IscBQewJ1euycbMVeLSglwQ11kDIgr46JiN1Oyy5vrXYRGsq', 'Nhân viên phục bếp', '1234567890', 'Đầu_bếp_1.jpg', 'Thành phố Cần Thơ , Quận Ninh Kiều , Phường Xuân Khánh, Đường 3/2', 1, '', NULL, NULL),
...
(14, 'mydrive.codecsharp@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', 'Nhân viên bếp 3', '914549113', 'Đầu_bếp_4.jpg', 'Thành phố Cần Thơ , Quận Ninh Kiều , Phường Xuân Khánh, đường 3/2', 1, 'MUJJUHU03J', NULL, NULL);
...
--
-- Table structure for table `phienlamviec`
--

CREATE TABLE `phienlamviec` (
  `phienlamviec_id` int UNSIGNED NOT NULL,
  `nv_id` int UNSIGNED NOT NULL,
  `phienlamviec_tt` int NOT NULL,
  `phienlamviec_dt` int NOT NULL,
  `phienlamviec_tc` int NOT NULL,
  `phienlamviec_gc` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `phienlamviec_tgbd` datetime NOT NULL,
  `phienlamviec_tgkt` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `phienlamviec`
--
...
(106, 1, 1, 145000, 50000, NULL, '2023-12-13 13:45:30', '2025-03-30 20:12:20'),
(107, 1, 0, 435000, 0, NULL, '2025-03-30 20:12:28', NULL);
...
CREATE TABLE `thongke` (
  `thongke_id` int NOT NULL,
  `thongke_ngay` date NOT NULL,
  `thongke_dt` int NOT NULL,
  `thongke_cp` int NOT NULL,
  `thongke_sl` int NOT NULL,
  `thongke_thd` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `tinnhan` (
  ...
  `nv_id_tntu` int UNSIGNED NOT NULL,
  `nv_id_tnden` int UNSIGNED NOT NULL,
  `tn_tinnhan` text NOT NULL,
  `tn_daxem` tinyint NOT NULL,
...
(528, 1, 3, 'Chào em', 1, '2025-03-30 13:22:29'),
(529, 3, 1, 'Sếp ơi tăng lương  đi', 1, '2025-03-30 13:22:57');
...
--
-- Indexes for table `ctphienlamviec`
--
...
--
-- Indexes for table `ctphieunhaphang`
--
...
--
-- Indexes for table `phienlamviec`
--
...
--
ALTER TABLE `baiviet`
  MODIFY `baiviet_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `ban`
--
ALTER TABLE `ban`
  MODIFY `ban_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;

--
-- AUTO_INCREMENT for table `binhluan`
--
ALTER TABLE `binhluan`
  MODIFY `binhluan_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `ctdinhluong`
--
ALTER TABLE `ctdinhluong`
  MODIFY `ctdl_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=140;

--
-- AUTO_INCREMENT for table `cthoadon`
--
ALTER TABLE `cthoadon`
  MODIFY `cthoadon_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1463;

--
-- AUTO_INCREMENT for table `ctphienlamviec`
--
ALTER TABLE `ctphienlamviec`
  MODIFY `ctphien_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT for table `ctphieunhaphang`
--
ALTER TABLE `ctphieunhaphang`
  MODIFY `ctnh_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=100;

--
-- AUTO_INCREMENT for table `ctquyen`
--
ALTER TABLE `ctquyen`
  MODIFY `ctquyen_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=84;

--
-- AUTO_INCREMENT for table `danhmuc`
--
ALTER TABLE `danhmuc`
  MODIFY `danhmuc_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;

--
-- AUTO_INCREMENT for table `datban`
--
ALTER TABLE `datban`
  MODIFY `datban_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=121;

--
-- AUTO_INCREMENT for table `dinhluong`
--
ALTER TABLE `dinhluong`
  MODIFY `dl_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `giamgia`
  MODIFY `gg_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `hinhanh`
--
ALTER TABLE `hinhanh`
  MODIFY `hinhanh_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;

--
-- AUTO_INCREMENT for table `hoadon`
--
ALTER TABLE `hoadon`
  MODIFY `hoadon_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=387;

--
-- AUTO_INCREMENT for table `khachhang`
--
ALTER TABLE `khachhang`
  MODIFY `khachhang_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;
...
--
ALTER TABLE `monan`
  MODIFY `ma_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;

--
-- AUTO_INCREMENT for table `nguyenlieu`
--
ALTER TABLE `nguyenlieu`
  MODIFY `nl_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;

--
-- AUTO_INCREMENT for table `nhacungcap`
--
ALTER TABLE `nhacungcap`
  MODIFY `ncc_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT for table `nhanvien`
--
ALTER TABLE `nhanvien`
  MODIFY `nv_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
...
--
-- AUTO_INCREMENT for table `phienlamviec`
--
ALTER TABLE `phienlamviec`
  MODIFY `phienlamviec_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=108;

--
-- AUTO_INCREMENT for table `phieunhaphang`
--
ALTER TABLE `phieunhaphang`
  MODIFY `pnh_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=84;

--
-- AUTO_INCREMENT for table `quyen`
--
ALTER TABLE `quyen`
  MODIFY `quyen_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `thongke`
--
ALTER TABLE `thongke`
  MODIFY `thongke_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=87;

--
-- AUTO_INCREMENT for table `tinnhan`
--
ALTER TABLE `tinnhan`
  MODIFY `tn_id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=530;
...
--
-- Constraints for table `ctdinhluong`
--
ALTER TABLE `ctdinhluong`
